            ...
            <div className="px-2">
                ...
                <div className="flex flex-col mb-4 px-2">
                    <div className="flex items-center space-x-2 mb-1">
                        <h2 className="text-[26px] font-bold text-black tracking-tight" onClick={handleBack}>Anna Mcconaughey, 25</h2>
                ...
                {/* Main Photo Section */}
                <div className="w-full relative rounded-[24px] overflow-hidden mb-6">
                    <img src={demoPhoto} alt="Main" className="w-full h-[500px] object-cover" />

                    {/* Insta Badge */}
                    <div className="absolute top-[40%] left-0 bg-gradient-to-r from-[#D62976] to-[#FA7E1E] text-white text-sm font-bold px-4 py-2 rounded-r-full shadow-md z-10">
                        @anrocks10
                    </div>
                ...
                <div className="px-2 space-y-6">
                    {/* About Me */}
                    <section>
                        <h3 className="text-[18px] font-bold text-black mb-2">About me</h3>
                        <p className="text-[#333333] text-[14px] leading-relaxed font-sans">
                    ...
                    {/* Looking For */}
                    <section>
                        <h3 className="text-[18px] font-bold text-black mb-3">I'm looking for</h3>
                        <div className="inline-flex items-center px-4 py-2.5 rounded-full bg-[#F9F7FF] border border-[#6F3BCE42] shadow-sm">
                    ...
                    {/* Basics */}
                    <section>
                        <h3 className="text-[18px] font-bold text-black mb-3">Basics</h3>
                        <div className="flex flex-col gap-3">
                            {/* Row 1 */}
                            <div className="flex items-center gap-3">
                                <div className="flex items-center px-4 py-2.5 rounded-full border border-[#6F3BCE42] bg-[#F9F7FF] shadow-sm">
                                    <img src={heightIcon} className="w-4 h-4 mr-2.5 object-contain" alt="Height" />
                                    <span className="text-[13px] font-medium text-black">5'8"</span>
                                </div>
                                <div className="flex items-center px-4 py-2.5 rounded-full border border-[#6F3BCE42] bg-[#F9F7FF] shadow-sm">
                                    <img src={religionIcon} className="w-4 h-4 mr-2.5 object-contain" alt="Religion" />
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex items-center px-4 py-2.5 rounded-full border border-[#6F3BCE42] bg-[#F9F7FF] shadow-sm">
                                    <img src={drinkIcon} className="w-4 h-4 mr-2.5 object-contain" alt="Drink" />
                                    <span className="text-[13px] font-medium text-black">Yes</span>
                                </div>
                                <div className="flex items-center px-4 py-2.5 rounded-full border border-[#6F3BCE42] bg-[#F9F7FF] shadow-sm">
                                    <img src={smokeIcon} className="w-4 h-4 mr-2.5 object-contain" alt="Smoke" />
                    ...
                    {/* Interests */}
                    <section>
                        <h3 className="text-[18px] font-bold text-black mb-3">My interests</h3>
                        <div className="flex flex-col gap-3">
                            {/* Row 1 */}
                            <div className="flex items-center gap-3">
                                <div className="flex items-center px-4 py-2.5 rounded-full border border-[#6F3BCE42] bg-[#F9F7FF] shadow-sm">
                    ...
                    <div className="space-y-6 mt-4">
                        {/* Card 1 */}
                        <div>
                            <div className="w-full rounded-[24px] overflow-hidden mb-2">
                                <img src={demoPhoto} alt="Prompt 1" className="w-full h-[500px] object-cover" />
                            </div>
                            <div className="bg-white rounded-[20px] p-4 shadow-sm border border-gray-100 flex justify-between items-center">
                                <div>
                                    <p className="text-[15px] font-bold text-black">I' ll never forget the time I</p>
                                    <p className="text-[12px] text-gray-500 mt-1">12 PM</p>
                                </div>
                        ...
                        <div>
                            <div className="w-full rounded-[24px] overflow-hidden mb-2">
                                <img src={demoPhoto2} alt="Prompt 2" className="w-full h-[500px] object-cover" />
                            </div>
                            <div className="bg-white rounded-[20px] p-4 shadow-sm border border-gray-100 flex justify-between items-center">
                                <div>
                                    <p className="text-[15px] font-bold text-black">Best travel story?</p>
                                    <p className="text-[12px] text-gray-500 mt-1">08 PM</p>
                                </div>
                                <div className="w-10 h-10 bg-[#7445E5]/10 rounded-full flex items-center justify-center">
                                    <img src={chatIcon} className="w-5 h-5 object-contain" alt="Chat" />
                                </div>
                        ...
                        <div>
                            <div className="w-full rounded-[24px] overflow-hidden mb-2">
                                <img src={demoPhoto3} alt="Prompt 3" className="w-full h-[500px] object-cover" />
                            </div>
                            <div className="bg-white rounded-[20px] p-4 shadow-sm border border-gray-100 flex justify-between items-center">
                                <div>
                                    <p className="text-[15px] font-bold text-black">My secret talent is...</p>
                                    <p className="text-[12px] text-gray-500 mt-1">10 AM</p>
                                </div>
                                <div className="w-10 h-10 bg-[#7445E5]/10 rounded-full flex items-center justify-center">
                                    <img src={chatIcon} className="w-5 h-5 object-contain" alt="Chat" />
                                </div>
